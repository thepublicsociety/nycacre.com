class AdvisorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @advisor.save
        format.html { redirect_to advisors_url, notice: 'Advisor was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @advisor.update_attributes(params[:advisor])
        format.html { redirect_to advisors_url, notice: 'Advisor was successfully updated.' }
  ...
  def set_class
    @bodyclass = "admin admin_advisors"
  end
end
